...
NOT: Yeterli kaynağım olmadıgı için "Vagrant up " tam anlamıyla gerçekleştirmedim.Kaynak yetersizliginden dolayı ya zaman aşımına ugradı yada  çalıştıktan kısa bir süre sonra sistem kitlendi.Bu sebeble bu aşamayı saglıklı bir şekilde test edemedim.
